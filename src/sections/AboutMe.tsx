function AboutMe() {
  return (
    <section
      id="aboutme"
      className="flex flex-col items-center justify-center h-[60vh] bg-white-300 gap-y-10 py-10 scroll-mt-20"
    >
      <div className="flex flex-col gap-y-2 relative">
        ...
        <a href="#aboutme" className="absolute -left-10 top-1.5 cursor-pointer">
      ...
      <div className="flex flex-wrap items-center justify-center gap-y-5 gap-x-10 px-10">
        <div className="flex w-3/7 gap-x-5 items-first">
          <img src="/icon/user.png" className="flex w-7 h-7" />
        ...
        <div className="flex w-3/7 gap-x-5 items-first">
          <img src="/icon/calendar.png" className="flex w-7 h-7" />
          <div className="flex flex-col gap-y-3 text-center">
        ...
        <div className="flex w-3/7 gap-x-5 items-first">
          <img src="/icon/location-pin.png" className="flex w-7 h-7" />
          <div className="flex flex-col gap-y-3 text-center">
        ...
        <div className="flex w-3/7 gap-x-5 items-first">
          <img src="/icon/phone.png" className="flex w-7 h-7" />
          <div className="flex flex-col gap-y-3 text-center">
        ...
        <div className="flex w-3/7 gap-x-5 items-first">
          <img src="/icon/email.png" className="flex w-7 h-7" />
          <div className="flex flex-col gap-y-3 text-center">
        ...
        <div className="flex w-3/7 gap-x-5 items-first">
          <img src="/icon/graduate.png" className="flex w-7 h-7" />
          <div className="flex flex-col gap-y-3 text-center">
